    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-6 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Create New Matter</h1>
            <p className="text-gray-600">Set up a new legal matter with client and lender information</p>
          </div>
              ...
              {steps.map((step, index) => (
                <div key={step.id} className="flex items-center">
                  ...
                  {index < steps.length - 1 && (
                    <i className="ri-arrow-right-line mx-2 text-gray-400 w-4 h-4"></i>
                  )}
                </div>
              ))}
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            {currentStep === 1 && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-gray-900">Matter Details</h2>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 whitespace-nowrap cursor-pointer"
                      >
                        Generate
                      </button>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      {Object.keys(formData.customFields).length > 0 && (
                        <div className="mt-3 pt-3 border-t border-gray-200">
                          <h4 className="font-medium text-gray-800 mb-2">Custom Fields:</h4>
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      {clients.map((client, index) => (
                        <p key={index} className="text-sm">{client.fullName || 'Unnamed Client'}</p>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg">
                      ...
                      {lenders.map((lender, index) => (
                        <p key={index} className="text-sm">{lender.name || 'Unnamed Lender'}</p>
                      ))}
                    </div>
                  </div>
                </div>
          ...
          <div className="flex items-center justify-between">
            <button
              ...
              className="flex items-center space-x-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
            >
            ...
            {currentStep < 5 ? (
              <button
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-blue-900 text-white rounded-lg hover:bg-blue-800 disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap cursor-pointer"
              >
                <span>Next</span>
              ...
              <button
                ...
                className="flex items-center space-x-2 px-6 py-3 bg-green-700 text-white rounded-lg hover:bg-green-800 whitespace-nowrap cursor-pointer"
              >
