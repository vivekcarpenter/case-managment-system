            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div>
                ...
                <p className="text-gray-600">
                  Overview of your legal case management system
                </p>
              </div>
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  >
                    <i
                      className={`${stat.icon} w-6 h-6 flex items-center justify-center`}
                    ></i>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 h-full flex flex-col">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-6 border-b border-gray-200 gap-2 sm:gap-0">
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    {recentMatters.map((matter) => (
                      <div
                        key={matter.id}
                        className="flex flex-col sm:flex-row sm:items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 gap-2 sm:gap-0"
                      >
                    ...
                    {upcomingTasks.map((task) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <span
                            className={`px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ml-2 ${getPriorityColor(
                              task.priority
                            )}`}
                          >
                            {task.priority}
                    ...
                    {recentClients.map((client) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs" style={{ color: "#334960" }}>
                            {client.matterRef}
                          </p>
                        </div>
