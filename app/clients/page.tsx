    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center w-full sm:w-auto space-y-2 sm:space-y-0 sm:space-x-3 mt-4 sm:mt-0">
            <button
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-gray-400 hover:text-gray-600 cursor-pointer mt-2 sm:mt-0"
            >
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-4">
          <div className="flex-1 relative">
            ...
            />
            <i className="ri-search-line absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4 flex items-center justify-center" />
          </div>
                ...
                >
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-1">
                          {client.riskAssessmentComplete ? (
                            <i className="ri-check-line w-3 h-3 text-green-600 flex items-center justify-center" />
                          ) : (
                            <i className="ri-close-line w-3 h-3 text-red-600 flex items-center justify-center" />
                          )}
                  ...
                  <td className="py-4 px-6">
                    <span className="inline-flex items-center px-2 py-1 bg-gray-100 text-gray-800 text-sm rounded-full">
                      <i className="ri-building-line w-3 h-3 mr-1 flex items-center justify-center" />
                      {client.lenderCount}
                    </span>
                  </td>
                  <td className="py-4">
      ...
      {filteredClients.length === 0 && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          <i className="ri-user-search-line w-12 h-12 text-gray-400 mx-auto mb-4 flex items-center justify-center" />
